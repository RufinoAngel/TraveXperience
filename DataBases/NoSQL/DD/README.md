...
Esta carpeta contiene el Diccionario de Datos de la base de datos NoSQL. Aquí se documentan las colecciones, atributos, tipos de datos y restricciones utilizadas en el proyecto.

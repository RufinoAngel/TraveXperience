...
Esta carpeta contiene los respaldos de la base de datos NoSQL. Su propósito es garantizar la recuperación de la información ante pérdidas de datos, errores o migraciones del sistema.

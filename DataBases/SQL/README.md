...
Esta carpeta contiene todos los recursos relacionados con la base de datos relacional del proyecto. Incluye diagramas entidad-relación, modelos relacionales, diccionarios de datos y respaldos.

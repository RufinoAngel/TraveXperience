...
Esta carpeta contiene el Diccionario de Datos de la base de datos SQL. Aquí se documentan las tablas, atributos, tipos de datos, claves primarias, claves foráneas y restricciones del sistema.

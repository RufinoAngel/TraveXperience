...
Esta carpeta contiene el Modelo Relacional de la base de datos. En él se representan las tablas, relaciones y dependencias derivadas del diseño conceptual del sistema.

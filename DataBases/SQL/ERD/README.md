...
Esta carpeta contiene los Diagramas Entidad-Relación (ERD) del proyecto. Estos diagramas representan gráficamente las entidades, atributos y relaciones de la base de datos.

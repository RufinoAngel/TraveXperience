...
Esta carpeta contiene el **conjunto de entrenamiento (training set)**, es decir, la partición de los datos procesados destinada a alimentar y ajustar los modelos de extracción de conocimiento y aprendizaje automático desarrollados en el proyecto.

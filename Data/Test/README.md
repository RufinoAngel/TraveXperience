...
Esta carpeta contiene el **conjunto de prueba (test set)**, utilizado para evaluar de manera final e imparcial el desempeño de los modelos entrenados, con datos que no fueron utilizados durante el entrenamiento ni la validación.
